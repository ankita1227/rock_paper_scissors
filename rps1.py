...
B2 = tkinter.Button(top, text ="Paper", command = lambda: rps1(win, lose, 2))
B2.grid(row=0, column=2)
B3 = tkinter.Button(top, text ="Scissors", command = lambda: rps1(win, lose, 3))
...
copy = Label(top, text= "RPS1 GUI on Tkinter on Python. By Anni 2019")
